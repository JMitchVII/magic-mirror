...
function init(font) {
    ...
    var welcomeMessage = "H A P P Y  B I R T H D A Y  Q U I N C E Y ! !"
...
var chars = ['H','','A','','P','','P','','Y','','','F','','A','','T','','H','','E','','R','','S','','D','','A','','Y',' ','D','','A','','D','!'];


window.setTimeout(queueInput,2000);
...
chars.forEach((element,i) => {
    window.setTimeout(function(){
        //onInput(element);
        console.log("Tried to queue input")
    },i*100)
});
}